...
class MakePaymentForm(forms.Form):
    ...
    expiry_month = forms.ChoiceField(label="Expiry Month", choices=MONTH_CHOICE, required=False)
    expiry_year = forms.ChoiceField(label="Expiry Year", choices=YEAR_CHOICE, required=False)
